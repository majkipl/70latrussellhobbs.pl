            ...
            <div class="col-12">
                ...
                <script>
                    ...
                    window.actionsFormatter = function (value, row, index) {
                        const view_button = [
                            '<a href="/panel/kolekcja/' + row.id + '" title="Zobacz" class="show icon">',
                            '   <i class="bi bi-eye-fill"></i>',
                            '</a>',
                            '<a href="/panel/kolekcja/zmien/' + row.id + '" title="Zmień" class="edit icon">',
                            '   <i class="bi bi-pencil-square"></i>',
                            '</a>',
                            '<a href="{{ route('api.collection') }}" title="Usuń" class="remove icon" data-id="' + row.id + '">',
                    ...
                    function buttons () {
                        return {
                            btnAdd: {
                                ...
                                icon: "bi-plus-square",
                                event: function () {
                                    window.location.href = '{{ route('panel.collection.create') }}';
                                },
                                attributes: {
                                    title: "Dodaj nowy",
                                },
