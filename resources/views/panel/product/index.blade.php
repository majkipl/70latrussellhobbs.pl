            ...
            <div class="col-12">
                ...
                <script>
                    ...
                    window.actionsFormatter = function (value, row, index) {
                        const view_button = [
                            '<a href="/panel/produkt/' + row.id + '" title="Zobacz" class="show icon">',
                            '   <i class="bi bi-eye-fill"></i>',
                            '</a>',
                            '<a href="/panel/produkt/zmien/' + row.id + '" title="Zmień" class="edit icon">',
                            '   <i class="bi bi-pencil-square"></i>',
                            '</a>',
                            '<a href="{{ route('api.product') }}" title="Usuń" class="remove icon" data-id="' + row.id + '">',
                    ...
                    function buttons () {
                        return {
                            btnAdd: {
                                ...
                                icon: "bi-plus-square",
                                event: function () {
                                    window.location.href = '{{ route('panel.product.create') }}';
                                },
                                attributes: {
                                    title: "Dodaj nowy",
                                },
